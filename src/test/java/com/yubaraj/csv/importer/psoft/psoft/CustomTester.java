...
//	List<CurrencyEnum> currencyEnums = new ArrayList<CurrencyEnum>(Arrays.asList(CurrencyEnum.values()));
...
//	}
	...
	System.out.println(JpaProcessor.getInstance().countByFromCurrencyCode("AWG", BigInteger.valueOf(500000l)));
